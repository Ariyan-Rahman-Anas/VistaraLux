...
//   const [photos, setPhotos] = useState<File[]>([]); // Change state to store multiple files
...
//         toast.error(`File ${file.name} Exceeds the maximum file size of ${MAX_SIZE_MB} MB`);
//         return false;
//       }
//     }
//     return true;
...
//     // Append all photos to the FormData object
//     photos.forEach((photo) => {
//       formDataObj.append("photos", photo); // Use "photos" to match backend expectation
//     });
